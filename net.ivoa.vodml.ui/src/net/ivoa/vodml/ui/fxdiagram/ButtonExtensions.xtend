...
class ButtonExtensions {
	...
	def static getSupertypeButton(Side side, String tooltip) {
		new SVGPath => [
			content = switch side {
	...
	def static getCompositionButton(Side side, String tooltip) {
		new SVGPath => [
			content = switch side {
	...
	def static getReferenceButton(Side side, String tooltip) {
		new SVGPath => [
			content = switch side {
